import { jsQuestions } from "./questions.js"; 
 ...
 export function questionBuilder(id) { 
   ...
   <header> 
     <div class="title">Quiz Appliation</div> 
     <div class="timer"> 
   ...
   <footer> 
   <div class="total-que js-total-que"> 
     <span><p>${questionResponse.id}</p> of <p>${count}</p>Quesions</span> 
   </div> 
   <button class="next-button js-next-que" data-question-id="${questionResponse.id}">Next Question.</button> 
   </footer>`; 
